    ...
    <div className="newshow-layout">
      ...
      <div className="newshow-main">
        ...
        <div className="post-item2">
          ...
          <div className="post-content2">
            ...
            <p className="location2">
              📍 1299 đường 23/10, thôn Võ Cạnh, phường Tây Nha Trang, tỉnh Khánh Hòa
            </p>
        ...
        <div className="left-info">
          ...
          <div className={`content ${expand ? "show" : ""}`}>
            ...
            <p>
              Thị trường cho thuê phòng trọ tại Nha Trang hiện nay rất đa dạng về
              phân khúc, từ phòng trọ giá rẻ cho sinh viên, công nhân cho đến các căn
              phòng khép kín, phòng trọ cao cấp, căn hộ mini đầy đủ tiện nghi. Các
              khu vực gần trường đại học như Đại học Nha Trang, Cao đẳng Du lịch, Cao
              đẳng Kỹ thuật, hay các khu vực đông dân cư, gần chợ, bệnh viện và khu
              công nghiệp luôn thu hút sự quan tâm lớn từ người thuê nhà. Bên cạnh
              yếu tố vị trí, người thuê ngày càng chú trọng đến chất lượng phòng trọ
              như diện tích sử dụng, mức độ an ninh, hệ thống điện nước, chỗ để xe,
              internet, cũng như môi trường sống xung quanh. Nhiều chủ nhà trọ tại
              Nha Trang đã đầu tư nâng cấp cơ sở vật chất, xây dựng phòng trọ mới,
              sạch sẽ, thoáng mát, có gác lửng, nhà vệ sinh riêng nhằm đáp ứng tốt
              hơn nhu cầu của người thuê. Giá cho thuê phòng trọ tại Nha Trang cũng
              khá linh hoạt, dao động tùy theo khu vực, diện tích và tiện nghi đi
              kèm. Người thuê có thể dễ dàng tìm được phòng trọ phù hợp với ngân sách
              của mình, từ mức giá bình dân cho sinh viên đến các lựa chọn cao cấp
              hơn dành cho người đi làm hoặc gia đình nhỏ. Việc tìm kiếm phòng trọ
              hiện nay cũng thuận tiện hơn nhờ các nền tảng trực tuyến, giúp người
              thuê nhanh chóng tiếp cận thông tin, hình ảnh và liên hệ trực tiếp với
              chủ trọ. Với sự phát triển không ngừng của thành phố, thị trường cho
              thuê phòng trọ, nhà trọ tại Nha Trang hứa hẹn sẽ tiếp tục sôi động
              trong thời gian tới, mang đến nhiều lựa chọn đa dạng và phù hợp cho mọi
              đối tượng có nhu cầu sinh sống, học tập và làm việc tại đây.
            </p>
          </div>

          <div className="see-more" onClick={() => setExpand(!expand)}>
            <span>{expand ? "Thu gọn" : "Xem thêm"}</span>
            <img src={down} alt="arrow" className={expand ? "rotate" : ""} />
          </div>
        </div>
      </div>
      {/* RIGHT SIDEBAR */}
      <div className="right-sidebar">
        ...
        <div className="sidebar-card">
          ...
          <div className="see-more" onClick={() => setShowMorePrice(!showMorePrice)}>
        ...
        <div className="sidebar-card">
          ...
          <div className="see-more" onClick={() => setShowMoreArea(!showMoreArea)}>
        ...
        <div className="sidebar-card">
          ...
          <div className="see-more" onClick={() => setShowMoreNear(!showMoreNear)}>
