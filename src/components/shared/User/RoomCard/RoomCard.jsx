...
function RoomCard({ data }) {
  // Destructuring dữ liệu từ props để code gọn hơn
    const { 
        ...
        images, rating, landlord, postDate, imageCount 
    } = data;
            ...
            <div className="room-card">
                ...
                <div className="room-details">
                    <div className="head-row">
                        ...
                        <div className="room-rating">
                            {[...Array(5)].map((_, i) => (
                                <Star key={i} size={16} fill={i < rating ? "#E1A730" : "none"} />
                            ))}
                        </div>
                    </div>
                ...
                <div className="landlord-info">
                    <div className="landlord-profile">
                        <img src={landlord.avatar} alt={landlord.name} className="landlord-avatar" />
